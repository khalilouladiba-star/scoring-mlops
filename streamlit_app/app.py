...
def get_api_url() -> str:
    """Cherche l'URL de l'API dans cet ordre :
    1. Les "Secrets" Streamlit Cloud (st.secrets)
    2. Une variable d'environnement API_URL
    3. Localhost par défaut (pour les tests en local)
    """
    try:
